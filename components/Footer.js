        ...
        <div className="py-10 sm:py-12 lg:py-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full overflow-hidden flex items-center justify-center shadow-md bg-white dark:bg-slate-800 p-1 border border-slate-200 dark:border-slate-700">
                <img
                  src="/images/logo.png"
                  alt="Logo Tlogomoyo"
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3 text-sm">
                ...
                <a href="tel:+6285259300843" className="text-slate-400 hover:text-primary-400 transition-colors">+62 852-5930-0843</a>
              </li>
            </ul>
          </div>
        </div>
