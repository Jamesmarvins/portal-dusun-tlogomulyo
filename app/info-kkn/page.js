        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-2xl border border-slate-200/80 shadow-[var(--shadow-card)] overflow-hidden animate-fade-in-up">
            ...
            <div className="p-6 sm:p-8">
              ...
              <p className="text-sm sm:text-base text-slate-600 leading-relaxed text-justify mb-6">
              ...
              return (
                ...
                >
                  ...
                  <div className="p-5 sm:p-6 flex flex-col flex-1">
                    ...
                    <p
                      className={`text-sm text-slate-500 leading-relaxed text-justify mb-4 flex-1 ${
