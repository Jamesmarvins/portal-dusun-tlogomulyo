    ...
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div className="animate-fade-in-up">
              ...
              <h1 className="font-heading text-3xl sm:text-4xl md:text-5xl lg:text-[3.5rem] xl:text-6xl font-extrabold leading-[1.1] tracking-tight mb-5 sm:mb-6">
                ...
                <br />
                <span className="gradient-text">Dusun Tlogomulyo</span>
              </h1>

              {/* Description */}
              <p className="text-base sm:text-lg text-slate-600 leading-relaxed max-w-xl mb-8 sm:mb-10">
                Kenali lebih dekat Dusun Tlogomulyo — sebuah dusun yang kaya
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                ...
                <Link
                  href="/info-kkn"
                  className="inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3.5 sm:py-4 bg-slate-900 text-white font-bold rounded-2xl shadow-sm hover:bg-slate-800 hover:shadow-md transition-all duration-300 text-sm sm:text-base"
                >
                  Info KKN
                  <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                ...
                <div className="relative bg-white/80 backdrop-blur-xl rounded-3xl p-8 border border-primary-100 shadow-2xl">
                  ...
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500">Tlogomulyo, Pacitan</p>
                    </div>
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-10 sm:mb-14 animate-fade-in-up">
            ...
            <p className="text-sm sm:text-base text-slate-500 max-w-2xl mx-auto leading-relaxed">
              Dusun Tlogomulyo merupakan bagian dari Desa Candi, Kecamatan
            ...
            {[
              {
                ...
                desc: "Dusun Tlogomulyo kaya akan hasil pertanian seperti singkong, empon-empon organik, kelapa, dan produk turunannya. Komoditas ini menjadi tulang punggung perekonomian masyarakat setempat.",
              ...
              },
              {
                ...
                desc: "Masyarakat Tlogomulyo dikenal ramah dan menjunjung tinggi nilai gotong royong. Tradisi dan kearifan lokal tetap terjaga di tengah perkembangan zaman modern.",
              ...
              },
              {
                ...
                desc: "Dusun Tlogomulyo menyambut baik program KKN dari berbagai perguruan tinggi. Kolaborasi antara akademisi dan masyarakat telah menciptakan dampak positif yang berkelanjutan.",
      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-earth-50 hero-pattern">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* CTA to Info KKN page */}
          <div className="text-center mt-10 sm:mt-14 animate-fade-in-up" style={{ animationDelay: "0.6s" }}>
            <Link
              href="/info-kkn"
              className="inline-flex items-center gap-2 px-8 py-4 bg-slate-900 text-white font-bold rounded-2xl shadow-lg hover:bg-slate-800 hover:shadow-xl transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] text-sm sm:text-base"
            >
              Pelajari Info KKN
      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-10 sm:mb-14 animate-fade-in-up">
            ...
            <p className="text-sm sm:text-base text-slate-500 max-w-2xl mx-auto leading-relaxed">
              Dusun Tlogomulyo terletak di Desa Candi, Kecamatan Pringkuku,
          ...
          <div className="grid lg:grid-cols-3 gap-6 lg:gap-8 items-stretch">
            ...
            <div className="lg:col-span-2 rounded-2xl overflow-hidden border border-slate-200/80 shadow-[var(--shadow-card)] hover:shadow-[var(--shadow-card-hover)] transition-shadow duration-500">
              <iframe
                ...
                title="Lokasi Dusun Tlogomulyo di Google Maps"
